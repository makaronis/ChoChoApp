...
import com.makaroni.chocho.databinding.FragmentAuthSignupBinding
...
class AuthSignUpFragment : Fragment(R.layout.fragment_auth_signup) {
    ...
    private val fragmentBinding by viewBinding(FragmentAuthSignupBinding::bind)
...
//            }
    ...
    private fun navigateTo(destination: ResId) {
        ...
        when (destination.id) {
            R.id.authVerificationFragment -> navController.navigate(AuthSignUpFragmentDirections.actionAuthFragmentToAuthVerificationFragment())
        }
    }
...
//        }
    ...
    private fun showVerificationDialog() {
        val dialog = AlertDialog.Builder(requireContext()).apply {
            setTitle(getString(R.string.auth_verification_title))
            setMessage(getString(R.string.auth_verification_msg))
    ...
    companion object {
        val TAG = AuthSignUpFragment::class.java.simpleName
    }
}